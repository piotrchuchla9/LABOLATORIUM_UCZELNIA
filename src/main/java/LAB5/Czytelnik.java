...
public class Czytelnik {
    ...
    public static int borrowedMagazines[] = new int[tabLength];
    ...
    public static void addData() {
        ...
        for (int i = 0; i < tabLength; i++) {
            ...
            System.out.println((i + 1) + "/" + tabLength + "\tPodaj ilosc wypozyczonych czasopism: ");
            borrowedMagazines[i] = sc.nextInt();
        }
    }
